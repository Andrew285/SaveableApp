...
interface TodoTaskDao {
    ...
    fun observeTasksForList(listId: Long): Flow<List<TaskWithTags>>

    @Transaction
    @Query("SELECT * FROM todo_tasks WHERE listId = :listId AND isArchived = 1 ORDER BY completedAt DESC")
    fun observeArchivedTasksForList(listId: Long): Flow<List<TaskWithTags>>
    ...
    suspend fun getById(id: Long): TodoTaskEntity?
